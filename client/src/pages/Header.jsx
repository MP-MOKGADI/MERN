...
//   {/* Search button */}
//   <button className="bg-pink-500 hover:bg-pink-600 text-white p-2 rounded-full">
//     <svg
//       xmlns="http://www.w3.org/2000/svg"
//       fill="none"
//       viewBox="0 0 24 24"
...
export default function Header() {
  ...
  return (
    <header className="flex justify-between items-center p-4  shadow-sm sticky top-0 bg-white z-50">
      {/* Logo */}
      <Link to="/" className="flex items-center gap-2 text-2xl font-bold">
        <svg
          xmlns="http://www.w3.org/2000/svg"
