...
//         <div className="text-center py-4 ">DON'T have an account yet?  <Link to="/register" className="underline text-black">REGISTER NOW!!</Link></div>
//       </form>
//       </div>
...
export default function LoginPage() {
  ...
  // ✅ Handle redirect here instead of inside handleLoginSubmit
  if (redirect) {
    return <Navigate to={'/'} />
  }
